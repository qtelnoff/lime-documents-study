...
def main(args):
    ...
    path_to_data = (
        DATA_DIR / "data" / "rvlcdip" / "reduced_version" / "dataset_info.jsonl"
    )
            ...
            for norm in PARAMETERS_GRID["norm"]:
                ...
                for kernel_width in PARAMETERS_GRID["kernel_width"]:
                    ...
                    for n_neighbors in PARAMETERS_GRID["n_neighbors"]:
                        ...
                        # For the X curve (Proportion of segments removed):
                        x_list = [0.0]
                        current_removed_pixels = 0
                        for idx in idx_sorted:
                            current_removed_pixels += segment_sizes.get(idx, 0)
                            x_list.append(current_removed_pixels / total_pixels)
